    ...
    <div class="container-fluid my-4 justify-content-center align-items-center">
        <div class="row justify-content-around my-4">
            <div class="col-md-5 bg-light shadow px-4 py-4">
                ...
                <a class="btn btn-outline-success btn-block" href="AddTaskType" role="button">Add Task Type</a>
            </div>
            <div class="col-md-5 bg-light shadow px-4 py-4">
                <h1 class=" display-1 text-warning text-center"><i class="fa fa-list-alt"></i></h1>
                <a class="btn btn-outline-warning btn-block" href="ShowAllTaskTypes" role="button">Show All Task Types</a>
            </div>
        </div>
    </div>
