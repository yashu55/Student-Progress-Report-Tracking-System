    ...
    <div class="container-fluid my-2">
        <div class="row justify-content-around">
            ...
            <div class="col-md-7 bg-light shadow px-4 py-4">
                ...
                <hr>
                <form class="was-validated" method="post" action="UpdateModuleSubmit">

					<div class="form-group">
                        <label for="ID">ModuleID</label>
                        <input value="<%= ((Module)request.getAttribute("Update_Module")).getModuleID() %>" type="text" class="form-control" name="moduleID" id="ID"
                    ...
                    <div class="form-group">
                        ...
                        <input value="<%= ((Module)request.getAttribute("Update_Module")).getModuleName() %>"  type="text" class="form-control" name="moduleName" id="name"
                    ...
                    <div class="form-group">
                        ...
                        <select value="<%= ((Module)request.getAttribute("Update_Module")).getModuleType() %>" class="form-control" id="moduleType" name="moduleType" required>
                    ...
                    <div class="form-group">
					    ...
					    <select value="<%= ((Module)request.getAttribute("Update_Module")).getTeacher().getTeacherID() %>" class="form-control" id="assignteacher" name="teacherID" required>
                    ...
                    <div class="form-group">
                        ...
                        <input value="<%= ((Module)request.getAttribute("Update_Module")).getStartDate() %>" class="form-control" type="date" name="startDate" id="startDate" required>
                    ...
                    <div class="form-group">
                        ...
                        <input value="<%= ((Module)request.getAttribute("Update_Module")).getEndDate() %>" class="form-control" type="date" name="endDate" id="endDate" required>
