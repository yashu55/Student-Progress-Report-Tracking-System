 ...
 <div class="container-fluid my-4">
        <div class="row justify-content-around my-4">
            <div class="col-md-5 bg-light shadow px-4 py-4">
                ...
                <a class="btn btn-outline-primary btn-block" href="LoggedStudentInfo" role="button">Student Info</a>
            </div>
            <div class="col-md-5 bg-light shadow px-4 py-4">
                <h1 class=" display-1 text-success text-center"><i class="fa fa-tasks"></i></h1>
                <a class="btn btn-outline-success btn-block" href="LoggedStudentTaskList" role="button">Student Tasks</a>
            </div>
