    ...
    <div class="container-fluid my-4 justify-content-center align-items-center">
        <div class="row justify-content-around my-4">
            <div class="col-md-5 bg-light shadow px-4 py-4">
                ...
                <a class="btn btn-outline-success btn-block" href="AddModule" role="button">Add Module</a>
            </div>
            <div class="col-md-5 bg-light shadow px-4 py-4">
                <h1 class=" display-1 text-danger text-center"><i class="fa fa-list-alt"></i></h1>
                <a class="btn btn-outline-danger btn-block" href="ShowAllModules" role="button">Show All Modules</a>
            </div>
        </div>
    </div>
