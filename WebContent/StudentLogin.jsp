    ...
    <div class="container-fluid my-2">
        <div class="row justify-content-around">
            ...
            <div class="col-md-7 bg-light shadow px-4 pt-4">
                <h4 class="display-4 ">
                    <i class="fa fa-user-graduate"></i> Student Login</h4>
                <p class="text-secondary">Enter valid student login details.</p>
                <hr>
                <!--Login form -->
                <form class="was-validated" method="post" action="StudentLoginSubmit">
                    <div class="form-group">
                        <label for="email">Email</label>
                        <input type="email" class="form-control" name="studentEmail" id="email" aria-describedby="emailHelpId"
